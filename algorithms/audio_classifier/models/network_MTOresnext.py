...
import torch
from algorithms.audio_classifier.models import pretrainedmodels
...
def waveResnext101_32x4d(pretrained='imagenet', num_classes=11):
...
def waveResnext101_64x4d(pretrained='imagenet', num_classes=11):
